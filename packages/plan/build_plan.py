...
GOALS = [
    {"id": "naklony", "title": "Наклоны и Пашчимоттанасана", "priority": 1},
...
DAYS = [
    {
        ...
        "slots": [
            ...
            slot("filler", "Добор 1", "12–16", "Кор — компрессия",
                 ["nogi-za-golovoy", "naklony"], ["ugolok", "znakomstvo-kor"]),
    ...
    },
    {
        ...
        "slots": [
            ...
            slot("main", "Основной урок", "45–48", "Задняя цепь — сила в амплитуде",
                 ["hanumanasana", "naklony"], ["prod-fit", "ladder-uhp", "hanu-2-1", "hanu-2-2"]),
            slot("filler", "Добор 1", "12–16", "Кор — компрессия",
                 ["naklony", "nogi-za-golovoy"], ["lolasana", "ugolok"]),
    ...
    },
    {
        ...
        "slots": [
            ...
            slot("filler", "Добор 1", "12–16", "Задняя цепь, амплитуда",
                 ["naklony", "hanumanasana"], ["hanu-3-1", "hanu-3-2"]),
    ...
    },
    {
        ...
        "slots": [
            slot("main", "Основной урок", "40–56", "Снятие тонуса, пассивная амплитуда",
                 ["naklony"], ["myagkaya-bedra", "myagkoe-vytyazhenie", "legkie-plechi"]),
            slot("filler", "Добор 1", "12–25", "Задняя цепь, мягкое вытяжение",
                 ["naklony"], ["passivnaya-nogi", "myagkaya-naklony"]),
    ...
    },
    {
        ...
        "priority": 1,
        "goals": ["naklony", "nogi-za-golovoy"],
        "slots": [
            slot("warmup", "Разогрев", "10–13", "ТБС сгибание, мобилизация",
                 ["naklony"], ["hanu-1-1"]),
            slot("main", "Основной урок", "52–66", "Глубокий наклон: пассивная и активная амплитуда",
                 ["naklony"], ["myagkaya-naklony", "tittibhasana", "tbs-shpagaty-3"]),
...
PLAN = {
    ...
    "priorities": [
        {"rank": 1, "title": "Наклоны · Хануманасана · Пашчимоттанасана"},
